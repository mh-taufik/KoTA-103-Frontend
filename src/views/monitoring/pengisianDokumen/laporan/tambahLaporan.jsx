      ...
      {isUploadFileByLink && (
        <div className="Example container">
          ...
          <Text type="warning" className="spacetop">
            * Laporan KP / PKL dikumpulkan hanya satu file <br /> * Laporan dapat dikumpulkan
            kembali selama belum mencapai deadline <br /> * Pastikan Gdrive dapat diakses <br /> *
            Pengumpulan kembali dapat dilakukan dengan mengisi form dibawah dan klik submit
          </Text>
