...
import { Card, Input, Popover, Progress, Space, message, notification, spin } from 'antd'
...
const FormPenilaianPembimbingJurusan = (props) => {
  ...
  const [penilaianIsDone, setPenilaianIsDone] = useState(false)
    ...
    <>
        ...
        <Col span={10}>
          <Card title="INFORMASI LOGBOOK PESERTA" bordered={true}>
            ...
            <Row>
              ...
              <Col span={6} style={{marginLeft:35}}>Tepat Waktu</Col>
              <Col span={2}>
            ...
            <Row>
              ...
              <Col span={6} style={{marginLeft:35}}>Terlambat</Col>
              <Col span={2}>
                {' '}
            ...
            <Row>
              ...
              <Col span={6} style={{marginLeft:35}}>Tidak Mengumpulkan</Col>
              <Col span={2}>
                {' '}
            ...
            <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Sangat Baik</Col>
               <Col span={2}>
             ...
             <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Baik</Col>
               <Col span={2}>
                 <Progress percent={10} status="active" />
               </Col>
               <Col span={14}>18 (dokumen)</Col>
             ...
             <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Cukup</Col>
               <Col span={2}>
                 <Progress percent={10} status="active" />
               </Col>
               <Col span={14}>18 (dokumen)</Col>
             ...
             <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Kurang Baik</Col>
               <Col span={2}>
                 <Progress percent={10} status="active" />
               </Col>
               <Col span={14}>18 (dokumen)</Col>
        ...
        <Col span={10}>
          <Card title="INFORMASI SELF ASSESSMENT PESERTA" bordered={true}>
            ...
            <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Sangat Baik (85-100)</Col>
               <Col span={2}>
             ...
             <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Baik (75-84)</Col>
               <Col span={2}>
                 <Progress percent={10} status="active" />
               </Col>
               <Col span={14}>18 (dokumen)</Col>
             ...
             <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Cukup (65-83)</Col>
               <Col span={2}>
             ...
             <Row>
               ...
               <Col span={6} style={{marginLeft:35}}>Kurang Baik (0-64)</Col>
               <Col span={2}>
                 <Progress percent={5} status="active" />
               </Col>
               <Col span={14}>18 (dokumen)</Col>
      ...
      <div className=" container">
        <Popover content={<div>Lihat isi detail dokumen laporan peserta</div>}>
          <Button size="small" onClick={buttonKembaliKeListHandling} type="primary">
            Kembali
          </Button>
        </Popover>
